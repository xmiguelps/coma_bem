...
/// Botao grande: terracota quando pode ser usado, bege quando bloqueado.
...
/// Botao branco com contorno (ex.: "Acessar como visitante").
class BotaoBranco extends StatelessWidget {
  final String texto;
  final IconData? icone;
  final VoidCallback? aoTocar;

  const BotaoBranco({super.key, required this.texto, this.icone, this.aoTocar});
...
/// Botao redondo (voltar, compartilhar, perfil).
